          ...
          >
            ...
            >
              <div
                style={{ WebkitBoxOrient: 'vertical' }}
                onClick={e => {
                  handleOpenMeasure && handleOpenMeasure(project._id)
                }}
              >
                {project.displayname}
              </div>
...
class PortfolioProposalProjectTable extends Component {
  state = {
  ...
  UNSAFE_componentWillMount() {
    ...
    handleSelectItems = handleSelecteProjectItems
    ids = selectedItems || []
    handleOpenMeasure = this.props.handleOpenMeasure
  }
  ...
  UNSAFE_componentWillReceiveProps(nextProps) {
    ...
    handleOpenMeasure = nextProps.handleOpenMeasure
  }
...
export default PortfolioProposalProjectTable
