...
export class Template extends React.Component {
  ...
  handleClickAddTemplate = event => {
    ...
    this.props.push('/template/create')
  }

  handleClickEditTemplate = (id, orgId) => {
    this.props.push({
  ...
  getOrgName = orgId => {
    const found = this.props.organizationList.find(org => org._id === orgId)
      ...
      <div className={classNames(styles.templateList, styles.table)}>
        ...
        >
          ...
          <div
            ...
            onClick={() => this.handleClickSort('createdByUser')}
          >
            Author{' '}
            {this.state.sort.key === 'createdByUser' ? (
              <i className="material-icons">arrow_downward</i>
            ) : (
              ''
            )}
            ...
            >
              ...
              >
                <div
                  ...
                  onClick={() =>
                    this.handleClickEditTemplate(template._id, template.orgId)
                  }
                >
                  <span>
              ...
              {this.props.manageAllOrgSelected && (
                <div
                  ...
                  data-header="Organization"
                >
                  <label className={styles.tableMobileShow}>Organization</label>
                  {this.getOrgName(template.orgId)}
                </div>
              )}
              <div
                className={classNames(
          ...
          <div className={styles.empty}>
            <div className={styles.emptyBody}>
              ...
              <div className={styles.emptyBodyDescription}>
                Document templates generate MS Word documents from building
                data.
              </div>
