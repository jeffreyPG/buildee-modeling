...
export class LibraryProjectListing extends React.Component {
  static propTypes = {
  ...
  componentDidMount = () => {
    this.props.getOrganizationProjects(this.props.library).then(projects => {
  ...
  UNSAFE_componentWillMount() {
    this.setState({ activeTab: this.props.tab })
  ...
  UNSAFE_componentWillReceiveProps = nextProps => {
    if (this.props.tab !== nextProps.tab) {
      this.setState({ activeTab: nextProps.tab, searchValue: '' })
    }
  }
  handleClick = e => {
  ...
  removeProjectsOutsideType = projects => {
    ...
    return new Promise(resolve => {
      var filteredProjects = projects.filter(function(proj) {
        ...
        if (
          proj.applicable_building_types &&
          proj.applicable_building_types.length
        ) {
          return proj.applicable_building_types.includes(buildingUse)
        } else {
          return true
        }
      })
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <i className='material-icons'>file_copy</i>Copy to
                              My Library
                            </div>
                          </div>
                        </div>
...
export default LibraryProjectListing
