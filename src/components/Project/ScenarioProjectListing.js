...
import projectStyles from './ProjectListing.scss'
import styles from './ScenarioProjectListing.scss'
...
export class ScenarioProjectListing extends React.Component {
  static propTypes = {
  ...
  componentDidMount = () => {
    ...
    this.props.getOrganizationProjects().then(projects => {
      let filteredProjects = projects.filter(
        project => project.type == 'Portfolio'
      )
      ...
      this.props.getMeasures().then(measures => {
        ...
        for (let key in measures) {
          ...
          if (project) {
            project = project.filter(item => item.type == 'Portfolio')
            project.map(item => {
      ...
      // } else {
      //   this.removeProjectsOutsideType(filteredProjects).then(() => {
    ...
    return Object.keys(appliedFilterValues).reduce((projects, key) => {
      ...
      if (key === 'type') {
        ...
        return projects.filter(
          project =>
            project.applicable_building_types &&
            project.applicable_building_types.indexOf(
              appliedFilterValues[key]
            ) !== -1
        )
      }
  ...
  handleDeleteProject = project => {
    ...
    this.props.handleDeleteProject(project).then(() => {
      this.props.getOrganizationProjects().then(projects => {
        ...
        selectedProjects = selectedProjects.filter(proj => {
          let projectObject = projects.find(
            project => JSON.stringify(proj.project) === JSON.stringify(project)
          )
          if (projectObject) return true
          return false
        })
        this.setState({
          orgLibrary: projects,
  ...
  handleProjectTab = clickedTab => {
    if (this.state.activeTab !== clickedTab) {
      ...
      this.setState({
        ...
        showPrivateExtras: '',
        showPublicExtras: '',
        orgLibrary: this.state.originalOrgLibrary,
        publicLibrary: this.state.originalPublicLibrary
      })
    }
  }
  ...
  render() {
    ...
    return (
      <div className={projectStyles.projectListing}>
        <div className={projectStyles.projectListingTitle}>
        ...
        <div
          className={classNames(projectStyles.tabs, projectStyles.sidePadding)}
        >
          <div className={projectStyles.container}>
            <div
        ...
        <div className={projectStyles.container}>
          <div className={projectStyles.projectListingTools}>
            <div className={projectStyles.projectListingFilter}>
              <div className={projectStyles.projectListingFilterMobile}>
              ...
              <div className={projectStyles.projectListingFilterHeader}>
                <h3>Filters</h3>
              </div>
              ...
              {Object.keys(filterValues).map((value, index) => {
                ...
                return (
                  <div
                    key={index}
                    className={classNames(
                      projectStyles.selectContainer,
                      this.state.hideProjectFilters ? projectStyles.hide : '',
                      value === 'type' ? styles.hide : ''
                    )}
                  >
                    <select
                    ...
                    >
                      ...
                      {filterLists[value] &&
                        filterLists[value].map((filterValue, index) => {
                          return (
                            <option
                              key={index}
            ...
            <div className={projectStyles.projectListingSearch}>
              <input
          ...
          {activeTab === 'myLibrary' && (
            <div className={projectStyles.table}>
              <div
                className={classNames(
                  projectStyles.tableHeader,
                  this.state.sort.direction === 'ASC'
                    ? projectStyles.tableHeaderSortASC
                    : projectStyles.tableHeaderSortDESC
                )}
              >
                <div
                  className={classNames(
                    projectStyles.tableRowItem,
                    projectStyles.tableRowItem_4
                  )}
                  onClick={() =>
                ...
                <div
                  className={classNames(
                    projectStyles.tableRowItem,
                    projectStyles.projectListingType
                  )}
                  onClick={() =>
                    this.handleClickSort(
                      'category',
                ...
                {!!this.props.library && (
                  <div className={projectStyles.tableRowItem} />
                )}
              </div>
              {this.state.orgLibrary &&
                ...
                this.state.orgLibrary.map((project, index) => {
                  return (
                    <div
                      key={index}
                      className={classNames(
                        projectStyles.tableRow,
                        this.state.selectedProjects.find(
                          proj =>
                            JSON.stringify(proj.project) ===
                            JSON.stringify(project)
                        )
                          ? projectStyles.projectListingSelected
                          : ''
                      )}
                    >
                      <div
                        className={classNames(
                          projectStyles.tableRowItem,
                          projectStyles.tableRowItem_4,
                          projectStyles.projectListingName,
                          !this.props.library ? projectStyles.pointer : ''
                        )}
                        onClick={() =>
                      ...
                      {!!this.props.library && (
                        <div
                          className={classNames(
                            projectStyles.tableRowItem,
                            projectStyles.projectListingLastCol
                          )}
                        >
                          <div
                            ...
                            className={classNames(
                              projectStyles.extras,
                              'extrasClick',
                              this.state.showPrivateExtras === index
                                ? projectStyles.extrasShow
                                : projectStyles.extrasHide
                            )}
                          >
                            <span className={projectStyles.extrasButton} />
                            <div
                              className={classNames(
                                projectStyles.extrasDropdown,
                                projectStyles.extrasDropdownRight
                              )}
                            >
                              <div
                                className={projectStyles.extrasLink}
                                onClick={() =>
              ...
              {!this.state.orgLibrary ||
                (this.state.orgLibrary.length == 0 && (
                  <div className={projectStyles.tableRow}>
                    <div className={projectStyles.tableRowItem}>
                    ...
                    >
                      ...
                      >
                        <div
                          ...
                          onClick={() =>
                            this.handleToggleExtras(index, 'public')
                          }
                          className={classNames(
                            projectStyles.extras,
                            this.state.showPublicExtras === index
                              ? projectStyles.extrasShow
                              : projectStyles.extrasHide
                          )}
                        >
...
export default ScenarioProjectListing
