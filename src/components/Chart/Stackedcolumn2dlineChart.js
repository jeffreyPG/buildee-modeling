...
import StackedColumn2DLineDY from 'fusioncharts/fusioncharts.charts'
...
ReactFC.fcRoot(FusionCharts, StackedColumn2DLineDY, FusionTheme)
...
export default function Stackedcolumn2dlineChart({
  chartConfig,
  categories,
  dataset
}) {
