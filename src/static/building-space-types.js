const commonSpaceTypes = [
  ...
  { value: 'roof', name: 'Roof' },
  { value: 'mechanical-room', name: 'Mechanical Room' },
  { value: 'storage', name: 'Storage' },
  { value: 'exterior', name: 'Exterior' },
  { value: 'open-parking-lot', name: 'Open Parking Lot' },
  {
    value: 'partially-enclosed-parking',
    name: 'Partially Enclosed Parking'
  },
  { value: 'completely-enclosed-parking', name: 'Completely Enclosed Parking' }
]

export function getSpaceTypeByUseType(useType) {
  switch (useType) {
...
export function getSpaceTypes(useType) {
  const buildingSpaceType = getSpaceTypeByUseType(useType)
  const combinedSpaceType = [...buildingSpaceType, ...commonSpaceTypes]
  const removeDuplicatedSpaceType = getUnique(combinedSpaceType, 'value')
  return removeDuplicatedSpaceType.sort((type1, type2) =>
